...
describe('User service request handler', function () {
  ...
  describe('When a search is called with a valid user', function () {
    beforeEach(function () {
      req.query = {
        username: 'test'
      };
    ...
    it('should respond with the user', function () {
      var sendSpy = res.send = sinon.spy();
      res.type = sinon.stub();
      res.status = sinon.stub().returns({
        send: sendSpy
  ...
  describe('When a search is called with a non-existent user', function () {
    beforeEach(function () {
      req.query = {
        username: 'bigmike'
      };
